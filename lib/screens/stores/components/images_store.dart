...
class ImagesStore extends StatelessWidget {
  // Passando parametro no construtor para receber os dados da categoria
  const ImagesStore({super.key, required this.store});

  // Passando categorias por parametro para pegar os seus dados
  ...
  Widget build(BuildContext context) {
    ...
    return FormField<dynamic>(
      ...
      //   return null;
      // },
      // Salvando as imagens, pegando o new image que foi uma variavel que criei em Categories para salvar tanto file como string
      //onSaved: (image) => stores.newImage = image,

...
class AccountReceiveSummary extends StatelessWidget {
  const AccountReceiveSummary({
    super.key,
    required this.accountReceiveManager,
  });

  final AccountReceiveManager accountReceiveManager;
                ...
                _buildColumn(
                  [
                    _buildSummaryItem(
                      ...
                      label: 'Valor Total',
                      value: accountReceiveManager
                          .calculateTotalAccountReceive(accountReceiveManager.filteredAccountReceive)
                          .toStringAsFixed(2)
                          .replaceAll('.', ','),
                    ),
                  ],
                ...
                _buildColumn(
                  [
                    _buildSummaryItem(
                      ...
                      value: accountReceiveManager
                          .calculateQuantityAccountReceive(accountReceiveManager.filteredAccountReceive)
                          .toString(),
                    ),
                  ],
                ),
